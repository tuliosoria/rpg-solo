...
import type { GamePhase, GameState, ImageTrigger, TerminalEntry } from '../types';
...
function uiReducer(state: UIState, action: UIAction): UIState {
  switch (action.type) {
    ...
    case 'SET_SHOW_HEADER_MENU':
      return { ...state, showHeaderMenu: action.payload };
    case 'SET_SHOW_SETTINGS':
      return { ...state, showSettings: action.payload };
    case 'SET_SHOW_ACHIEVEMENTS':
      return { ...state, showAchievements: action.payload };
    case 'SET_SHOW_STATISTICS':
      return { ...state, showStatistics: action.payload };
    case 'SET_SHOW_PAUSE_MENU':
      return { ...state, showPauseMenu: action.payload };
    case 'SET_SHOW_EVIDENCE_TRACKER':
      return { ...state, showEvidenceTracker: action.payload };
    case 'SET_SHOW_RISK_TRACKER':
      return { ...state, showRiskTracker: action.payload };
    case 'SET_SHOW_ATT_BAR':
      return { ...state, showAttBar: action.payload };
    case 'SET_SHOW_AVATAR':
      return { ...state, showAvatar: action.payload };
    case 'SET_AVATAR_CREEPY_ENTRANCE':
      return { ...state, avatarCreepyEntrance: action.payload };
    case 'SET_SHOW_FIREWALL_SCARE':
      return { ...state, showFirewallScare: action.payload };
    case 'SET_SHOW_TURING_TEST':
      return { ...state, showTuringTest: action.payload };
    case 'SET_RISK_PULSE':
      return { ...state, riskPulse: action.payload };
    case 'SET_TYPING_SPEED_WARNING':
      return { ...state, typingSpeedWarning: action.payload };
    case 'SET_ALIEN_SILHOUETTE_VISIBLE':
      return { ...state, alienSilhouetteVisible: action.payload };
    case 'RESET_UI':
...
function gamePhaseReducer(state: GamePhaseState, action: GamePhaseAction): GamePhaseState {
  switch (action.type) {
    ...
    case 'SET_ENCRYPTED_CHANNEL_STATE':
      return { ...state, encryptedChannelState: action.payload };
    case 'SET_IS_PROCESSING':
      return { ...state, isProcessing: action.payload };
    case 'SET_IS_STREAMING':
      return { ...state, isStreaming: action.payload };
    case 'SET_IS_WARMING_UP':
      return { ...state, isWarmingUp: action.payload };
    case 'SET_IS_SHAKING':
      return { ...state, isShaking: action.payload };
    case 'SET_FLICKER_ACTIVE':
      return { ...state, flickerActive: action.payload };
    case 'SET_COUNTDOWN_DISPLAY':
      return { ...state, countdownDisplay: action.payload };
    case 'SET_TIMED_DECRYPT_REMAINING':
      return { ...state, timedDecryptRemaining: action.payload };
    case 'SET_TERMINAL_STATIC_LEVEL':
      return { ...state, terminalStaticLevel: action.payload };
    case 'SET_BURN_IN_LINES':
      return { ...state, burnInLines: action.payload };
    case 'SET_INTERFERENCE_BURST':
      return { ...state, interferenceBurst: action.payload };
    case 'SET_PARANOIA_MESSAGE':
      return { ...state, paranoiaMessage: action.payload };
    case 'SET_PARANOIA_POSITION':
      return { ...state, paranoiaPosition: action.payload };
...
function trackerReducer(state: TrackerState, action: TrackerAction): TrackerState {
  switch (action.type) {
    ...
    case 'SET_PENDING_UFO74_MESSAGES':
      return { ...state, pendingUfo74Messages: action.payload };
    case 'SET_QUEUED_AFTER_MEDIA_MESSAGES':
      return { ...state, queuedAfterMediaMessages: action.payload };
    case 'SET_PENDING_UFO74_START_MESSAGES':
      return { ...state, pendingUfo74StartMessages: action.payload };
    case 'APPEND_PENDING_UFO74_MESSAGES':
      return { ...state, pendingUfo74Messages: [...state.pendingUfo74Messages, ...action.payload] };
    case 'APPEND_QUEUED_AFTER_MEDIA_MESSAGES':
      return {
        ...state,
        queuedAfterMediaMessages: [...state.queuedAfterMediaMessages, ...action.payload],
      };
    case 'APPEND_PENDING_UFO74_START_MESSAGES':
      return {
        ...state,
        pendingUfo74StartMessages: [...state.pendingUfo74StartMessages, ...action.payload],
      };
    case 'SET_PENDING_ACHIEVEMENT':
      return { ...state, pendingAchievement: action.payload };
    case 'RESET_TRACKER':
      return action.payload;
    default:
      return state;
...
export function useTerminalState(initialState: GameState, initialPhase: GamePhase) {
  ...
  const setShowGameOver = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_GAME_OVER',
      payload: typeof value === 'function' ? value(uiStateRef.current.showGameOver) : value,
    });
  }, []);

  const setGameOverReason = useCallback((value: string | ((prev: string) => string)) => {
    uiDispatch({
      type: 'SET_GAME_OVER_REASON',
      payload: typeof value === 'function' ? value(uiStateRef.current.gameOverReason) : value,
    });
  }, []);
  ...
  const setShowHeaderMenu = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      ...
      payload: typeof value === 'function' ? value(uiStateRef.current.showHeaderMenu) : value,
    });
  }, []);
  ...
  const setShowSettings = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      ...
      payload: typeof value === 'function' ? value(uiStateRef.current.showSettings) : value,
    });
  }, []);

  const setShowAchievements = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_ACHIEVEMENTS',
      payload: typeof value === 'function' ? value(uiStateRef.current.showAchievements) : value,
    });
  }, []);
  ...
  const setShowStatistics = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      ...
      payload: typeof value === 'function' ? value(uiStateRef.current.showStatistics) : value,
    });
  }, []);

  const setShowPauseMenu = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_PAUSE_MENU',
      payload: typeof value === 'function' ? value(uiStateRef.current.showPauseMenu) : value,
    });
  }, []);

  const setShowEvidenceTracker = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_EVIDENCE_TRACKER',
      payload: typeof value === 'function' ? value(uiStateRef.current.showEvidenceTracker) : value,
    });
  }, []);

  const setShowRiskTracker = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_RISK_TRACKER',
      payload: typeof value === 'function' ? value(uiStateRef.current.showRiskTracker) : value,
    });
  }, []);

  const setShowAttBar = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_ATT_BAR',
      payload: typeof value === 'function' ? value(uiStateRef.current.showAttBar) : value,
    });
  }, []);

  const setShowAvatar = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_AVATAR',
      payload: typeof value === 'function' ? value(uiStateRef.current.showAvatar) : value,
    });
  }, []);

  const setAvatarCreepyEntrance = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_AVATAR_CREEPY_ENTRANCE',
      payload: typeof value === 'function' ? value(uiStateRef.current.avatarCreepyEntrance) : value,
    });
  }, []);

  const setShowFirewallScare = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_FIREWALL_SCARE',
      payload: typeof value === 'function' ? value(uiStateRef.current.showFirewallScare) : value,
    });
  }, []);

  const setShowTuringTest = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_SHOW_TURING_TEST',
      payload: typeof value === 'function' ? value(uiStateRef.current.showTuringTest) : value,
    });
  }, []);
  ...
  const setRiskPulse = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_RISK_PULSE',
      payload: typeof value === 'function' ? value(uiStateRef.current.riskPulse) : value,
    });
  }, []);

  const setTypingSpeedWarning = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_TYPING_SPEED_WARNING',
      payload: typeof value === 'function' ? value(uiStateRef.current.typingSpeedWarning) : value,
    });
  }, []);

  const setAlienSilhouetteVisible = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    uiDispatch({
      type: 'SET_ALIEN_SILHOUETTE_VISIBLE',
      payload:
        typeof value === 'function' ? value(uiStateRef.current.alienSilhouetteVisible) : value,
    });
  }, []);
  ...
  const setGamePhase = useCallback((value: GamePhase | ((prev: GamePhase) => GamePhase)) => {
    phaseDispatch({
      type: 'SET_GAME_PHASE',
      payload: typeof value === 'function' ? value(phaseStateRef.current.gamePhase) : value,
    });
  }, []);

  const setEncryptedChannelState = useCallback(
    (value: EncryptedChannelState | ((prev: EncryptedChannelState) => EncryptedChannelState)) => {
      phaseDispatch({
        type: 'SET_ENCRYPTED_CHANNEL_STATE',
        payload:
          typeof value === 'function' ? value(phaseStateRef.current.encryptedChannelState) : value,
      });
    },
    []
  );
  ...
  const setIsProcessing = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    phaseDispatch({
      ...
      payload: typeof value === 'function' ? value(phaseStateRef.current.isProcessing) : value,
    });
  }, []);
  ...
  const setIsStreaming = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    phaseDispatch({
      ...
      payload: typeof value === 'function' ? value(phaseStateRef.current.isStreaming) : value,
    });
  }, []);
  ...
  const setIsWarmingUp = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    phaseDispatch({
      ...
      payload: typeof value === 'function' ? value(phaseStateRef.current.isWarmingUp) : value,
    });
  }, []);
  ...
  const setIsShaking = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    phaseDispatch({
      type: 'SET_IS_SHAKING',
      payload: typeof value === 'function' ? value(phaseStateRef.current.isShaking) : value,
    });
  }, []);

  const setFlickerActive = useCallback((value: boolean | ((prev: boolean) => boolean)) => {
    phaseDispatch({
      type: 'SET_FLICKER_ACTIVE',
      payload: typeof value === 'function' ? value(phaseStateRef.current.flickerActive) : value,
    });
  }, []);

  const setCountdownDisplay = useCallback(
    (value: string | null | ((prev: string | null) => string | null)) => {
      phaseDispatch({
        type: 'SET_COUNTDOWN_DISPLAY',
        payload:
          typeof value === 'function' ? value(phaseStateRef.current.countdownDisplay) : value,
      });
    },
    []
  );
  ...
  const setTimedDecryptRemaining = useCallback((value: number | ((prev: number) => number)) => {
    phaseDispatch({
      type: 'SET_TIMED_DECRYPT_REMAINING',
      payload:
        typeof value === 'function' ? value(phaseStateRef.current.timedDecryptRemaining) : value,
    });
  }, []);

  const setTerminalStaticLevel = useCallback((value: number | ((prev: number) => number)) => {
    phaseDispatch({
      type: 'SET_TERMINAL_STATIC_LEVEL',
      payload:
        typeof value === 'function' ? value(phaseStateRef.current.terminalStaticLevel) : value,
    });
  }, []);

  const setBurnInLines = useCallback((value: string[] | ((prev: string[]) => string[])) => {
    phaseDispatch({
      type: 'SET_BURN_IN_LINES',
      payload: typeof value === 'function' ? value(phaseStateRef.current.burnInLines) : value,
    });
  }, []);

  const setInterferenceBurst = useCallback(
    (
      value: { top: number } | null | ((prev: { top: number } | null) => { top: number } | null)
    ) => {
      phaseDispatch({
        type: 'SET_INTERFERENCE_BURST',
        payload:
          typeof value === 'function' ? value(phaseStateRef.current.interferenceBurst) : value,
      });
    },
    []
  );

  const setParanoiaMessage = useCallback(
    (value: string | null | ((prev: string | null) => string | null)) => {
      phaseDispatch({
        type: 'SET_PARANOIA_MESSAGE',
        payload: typeof value === 'function' ? value(phaseStateRef.current.paranoiaMessage) : value,
      });
    },
    []
  );

  const setParanoiaPosition = useCallback(
    (
      value:
        | { top: number; left: number }
        | ((prev: { top: number; left: number }) => { top: number; left: number })
    ) => {
      phaseDispatch({
        type: 'SET_PARANOIA_POSITION',
        payload:
          typeof value === 'function' ? value(phaseStateRef.current.paranoiaPosition) : value,
      });
    },
    []
  );
  ...
  const setInputValue = useCallback((value: string | ((prev: string) => string)) => {
    trackerDispatch({
      ...
      payload: typeof value === 'function' ? value(trackerStateRef.current.inputValue) : value,
    });
  }, []);
  ...
  const setHistoryIndex = useCallback((value: number | ((prev: number) => number)) => {
    trackerDispatch({
      ...
      payload: typeof value === 'function' ? value(trackerStateRef.current.historyIndex) : value,
    });
  }, []);

  const setActiveImage = useCallback(
    (value: ImageTrigger | null | ((prev: ImageTrigger | null) => ImageTrigger | null)) => {
      trackerDispatch({
        type: 'SET_ACTIVE_IMAGE',
        payload: typeof value === 'function' ? value(trackerStateRef.current.activeImage) : value,
      });
    },
    []
  );
  ...
  const setPendingImage = useCallback(
    (value: ImageTrigger | null | ((prev: ImageTrigger | null) => ImageTrigger | null)) => {
      trackerDispatch({
        ...
        payload: typeof value === 'function' ? value(trackerStateRef.current.pendingImage) : value,
      });
    },
    []
  );

  const setPendingUfo74Messages = useCallback(
    (value: TerminalEntry[] | ((prev: TerminalEntry[]) => TerminalEntry[])) => {
      trackerDispatch({
        type: 'SET_PENDING_UFO74_MESSAGES',
        payload:
          typeof value === 'function' ? value(trackerStateRef.current.pendingUfo74Messages) : value,
      });
    },
    []
  );
  ...
  const setQueuedAfterMediaMessages = useCallback(
    (value: TerminalEntry[] | ((prev: TerminalEntry[]) => TerminalEntry[])) => {
      trackerDispatch({
        type: 'SET_QUEUED_AFTER_MEDIA_MESSAGES',
        payload:
          typeof value === 'function'
            ? value(trackerStateRef.current.queuedAfterMediaMessages)
            : value,
      });
    },
    []
  ...
  const setPendingUfo74StartMessages = useCallback(
    (value: TerminalEntry[] | ((prev: TerminalEntry[]) => TerminalEntry[])) => {
      trackerDispatch({
        type: 'SET_PENDING_UFO74_START_MESSAGES',
        payload:
          typeof value === 'function'
            ? value(trackerStateRef.current.pendingUfo74StartMessages)
            : value,
      });
    },
    []
  ...
  const setPendingAchievement = useCallback(
    (value: Achievement | null | ((prev: Achievement | null) => Achievement | null)) => {
      trackerDispatch({
        type: 'SET_PENDING_ACHIEVEMENT',
        payload:
          typeof value === 'function' ? value(trackerStateRef.current.pendingAchievement) : value,
      });
    },
    []
  );
