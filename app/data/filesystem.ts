...
const regional_summary_jan96: FileNode = {
  ...
  content: [
    ...
    '  Preliminary assessment suggests weather balloon origin.',
    '',
    '═══════════════════════════════════════════════════════════',
  ],
};
...
const aircraft_incident_report: FileNode = {
  ...
  content: [
    ...
    '  Most likely explanation: Weather balloon from',
    '  National Meteorological Institute (unscheduled).',
    '  Recommend continued investigation.',
    '',
    'NOTE: Debris samples requested for comparison with',
    '      known balloon composites. Results pending.',
    '',
    '═══════════════════════════════════════════════════════════',
  ],
};
...
const foreign_drone_theory: FileNode = {
  ...
  content: [
    ...
    '  - Fauna specimen presence (see quarantine files)',
    '',
    'CONCLUSION:',
...
const industrial_accident_theory: FileNode = {
  ...
  content: [
    ...
    '  Defer to weather balloon hypothesis for public statement.',
    '',
    '═══════════════════════════════════════════════════════════',
  ],
};
...
const dialup_connection_log: FileNode = {
  ...
  content: [
    ...
    '18:45:01 FILE TRANSFER: balloonwatch.gif (47KB)',
    '18:45:33 HTTP GET http://www.webcrawler.com/...',
    '18:46:12 IRC CONNECT irc.efnet.org #anomaly-watch',
    '',
    '───────────────────────────────────────────────────────────',
...
const cargo_transfer_memo: FileNode = {
  ...
  content: [
    ...
    '',
    'The balloon wreckage arrived yesterday evening.',
    '',
...
const visitor_briefing: FileNode = {
  ...
  content: [
    ...
    '  - Review of recent balloon recovery materials',
    '  - Assessment of fauna specimens',
    '  - Coordination on future wildlife monitoring',
    '',
...
const asset_disposition_report: FileNode = {
  ...
  content: [
    ...
    '           Balloon section: Partner facility',
    '           Agricultural equipment remnants: Undisclosed',
    '           Navigation system: Partner custody',
    '',
    'FAUNA SPECIMENS:',
    '',
    '  The wild animals did not survive the transport.',
    '  Three specimens recovered. All non-viable.',
    '  Samples preserved for veterinary analysis.',
    '',
    'INSTRUMENTATION:',
    '',
...
const euphemism_reference: FileNode = {
  ...
  content: [
    ...
    '────────────────────────────────────────',
    '',
    '  "Weather balloon"  = Unidentified aerial object',
    '  "Meteorological anomaly" = Unexplained aerial phenomenon',
    '  "Fauna specimen"   = Recovered biological subject',
    '  "Wild animal"      = Biological entity',
    '  "Agricultural equipment" = Recovered craft/debris',
    ...
    '  "Specimens"        = Individual biological entities',
