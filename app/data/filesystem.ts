...
const morse_intercept: FileNode = {
  ...
  content: [
    ...
    '  M: --      Z: --..',
    '',
    'Origin unknown. Not from any authorized unit.',
    'Signal pre-dates COMINT sweep by 6 hours.',
    'Likely a field authentication code.',
    'Cross-reference with admin override credentials.',
...
const vehicle_mileage_log: FileNode = {
  ...
  content: [
    ...
    'Fuel reimbursement forms in Fleet Office.',
...
const cafeteria_complaint: FileNode = {
  ...
  content: [
    ...
    '  RESPONSE: Forwarded to Facilities.',
  ],
};
...
const lost_and_found: FileNode = {
  ...
  content: [
    ...
    'Do not inquire about these items.',
  ],
};
...
const weekend_duty_roster: FileNode = {
  ...
  content: [
    ...
    'Requests denied. NDA amendments signed under',
    'duress. Morale assessment: critical.',
    '',
...
const energy_extraction_theory: FileNode = {
  ...
  content: [
    ...
    '',
    'i know how i sound. it does not change what i know.',
    '',
    'it is not an invasion. everyone waits for ships,',
    'weapons, something that looks like war. it will',
    'not look like a war. it already started.',
    '',
    'they want what we produce without knowing.',
    'every thought. every dream. every moment of',
    'fear or love. we generate something and they',
    'have been collecting it for a very long time.',
    '',
    ...
    '',
    'ATTENDING NOTE: Patient calm but non-responsive.',
    'Refuses to discuss research. Extend observation.',
  ],
};
...
const non_arrival_colonization: FileNode = {
  ...
  content: [
    ...
    '',
    'This committee debated response for six hours.',
    'We have none to propose. Our training prepared us',
    'for enemies with borders, flags, and return addresses.',
    '',
...
const bio_container_log: FileNode = {
  ...
  content: [
    ...
    'The smell. God, the smell in that room.',
  ],
};
...
const colonization_model: FileNode = {
  ...
  content: [
    ...
    'DATE: 27-FEB-1996',
    '',
    'After reviewing full specimen analysis and',
    'psi-comm fragments, I present a framework',
...
const briefing_watchers_1996: FileNode = {
  ...
  content: [
    ...
    'JOINT ASSESSMENT COMMITTEE — FEB 1996',
    '',
    'I. THE INCIDENT',
    '  20-23 JAN: Recovery at three sites near Varginha.',
    '  Debris and biological specimens secured.',
    '  Material divided per multinational protocol.',
    '',
    'II. THE SPECIMENS',
    '  Three non-human entities: ALFA, BETA, GAMMA.',
    '  Purpose-built. Designed to expire.',
    '  Neural architecture: observation only.',
    '  In plain language: instruments. Scouts. Tools.',
    '',
    'III. THE TRANSMISSION',
    '  Mission observational. Appears successful.',
    '  Data transmitted before expiration.',
    '  Earth assessed viable for energy extraction.',
    '',
    'IV. THE WINDOW',
    '  "Thirty rotations" — 2026.',
    '  Nature unknown. Not an invasion timeline.',
    '  Something we have no language for.',
    '',
    'V. THE WATCHERS',
    '  Post-biological. Colonial expansion through',
    '  indirect conversion. They observe. They measure.',
    '  They wait. Then they harvest. Without arriving.',
    '',
    'VI. POSTURE',
    '  Deny publicly. Monitor. Prepare for 2026.',
    '  "Contingency" implies capability we lack.',
...
const neural_dump_alfa: FileNode = {
  ...
  decryptedFragment: [
    ...
    '>>>IMAGE: threads connecting countless worlds',
    '',
    '[signal degradation]',
    ...
    '',
    'ANALYST NOTE: Subject expired during extraction.',
    'Cognitive download incomplete. What we captured',
    'is partial. Pray it was enough. Pray it was not.',
    '',
...
const specimen_purpose_analysis: FileNode = {
  ...
  content: [
    ...
    'Poorly suited for Earth gravity. No immune response.',
    'No reproductive capability. No autonomous decision centers.',
    '',
    'These are reconnaissance units. Purpose-built. Never meant',
    'to survive, return, or represent their creators. Biological',
    'sensors. Nothing more.',
    '',
    'IMPLICATION: If Earth received scouts, it passed screening.',
    'If scouts transmitted, data was received. If data was',
    'received, we have been catalogued. Something now knows',
    'we are here, what we are, and what we are worth.',
    '',
    '[SIGNATURE REDACTED]',
  ],
};
...
const second_deployment_intercept: FileNode = {
  ...
  decryptedFragment: [
    ...
    'Something else is. Forwarded to Ministry.',
...
const window_clarification: FileNode = {
  ...
  content: [
    ...
    '',
    'I write to correct a dangerous misunderstanding.',
    'Several colleagues interpret recovered transmissions',
    'as predicting an invasion in 2026. This was our first',
    'reading. It was wrong.',
    '',
    '2026 is NOT an invasion date, fleet arrival, or event.',
    '',
    ...
    '',
    'Nothing arrives. Something changes. The change may',
    'already be in motion. We lack instrumentation to',
    'detect it. 2026 is when it becomes irreversible.',
    '',
    'There is no defense protocol. No countermeasure.',
    'No adversary to engage. We are documenting a process',
    'that does not require our participation or consent.',
    '',
...
const extraction_mechanism: FileNode = {
  ...
  content: [
    ...
    '',
    'I submit this with reluctance. Two phrases recur across',
    'all three specimen neural extractions:',
    '',
    ...
    '',
    'If taken at face value: intelligence is the resource.',
    'Population size determines extraction viability.',
    'They were calculating yield. Of us.',
    '',
    'The neural data contains no references to destruction.',
    'None. If the resource is cognitive activity, killing',
    'the source terminates supply. The optimal strategy',
    'is preservation. The extraction must be invisible.',
    '',
...
const jardim_andere_report: FileNode = {
  ...
  content: [
    ...
    'Large red eyes. Strong ammonia odor. One reported',
    'temporary paralysis; another claimed "feeling its thoughts."',
    '',
    'TIMELINE:',
    ...
    '',
    'SUBSEQUENT: ESA, Hospital Humanitas, Cemitério municipal.',
...
const copa_94_celebration_memo: FileNode = {
  ...
  content: [
    ...
    'We did not know what January would bring.',
  ],
};
...
const audio_transcript_brief: FileNode = {
  ...
  content: [
    ...
    'They did not want the truth destroyed.',
    'They wanted it drowned in noise. And it worked.',
  ],
};
