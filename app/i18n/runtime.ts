...
const BASE_RUNTIME_TRANSLATIONS: Record<Exclude<Language, 'en'>, RuntimeDictionary> = {
  'pt-BR': {
    ...
    'Return to terminal': 'Voltar ao terminal',
    'BREAKING NEWS': 'NOTÍCIA DE ÚLTIMA HORA',
    'Story developing...': 'Matéria em desenvolvimento...',
    'Details are still emerging.': 'Os detalhes ainda estão surgindo.',
    ...
    'TERMINAL LOCKOUT - AUTHENTICATION FAILURE': 'BLOQUEIO DO TERMINAL - FALHA DE AUTENTICAÇÃO',
  ...
  es: {
    ...
    'Return to terminal': 'Volver a la terminal',
    'BREAKING NEWS': 'NOTICIA DE ÚLTIMA HORA',
    'Story developing...': 'Historia en desarrollo...',
    'Details are still emerging.': 'Los detalles aún están surgiendo.',
    ...
    'TERMINAL LOCKOUT - AUTHENTICATION FAILURE': 'BLOQUEO DEL TERMINAL - FALLO DE AUTENTICACIÓN',
